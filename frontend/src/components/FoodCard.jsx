...
import { FaLeaf, FaMinus, FaPlus, FaRegStar, FaShoppingCart } from "react-icons/fa"
    ...
    return (
        <div className='w-[250px] rounded-2xl border-2 border-[#ff4d2d] bg-white shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col'>
            <div className='relative w-full h-[170px] flex justify-center items-center bg-white'>
                ...
                {/* Food image */}
                <img src={data.image} alt="food image" className='w-full h-full object-cover transition-transform duration-300 hover:scale-105' />

            </div>

            {/* Ratings Section*/}
            <div className='flex-1 flexflex-col p-4'>
