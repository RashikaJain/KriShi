        ...
        <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100'>
            ...
            <form className='space-y-5'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <input type='text'  placeholder='City Name' className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2  focus:ring-orange-500'/>
                    </div>

                    {/* State */}
                    <div>
                        <label className='block text-sm font-medium text-gray-700 mb-1'>State</label>
                    <input type='text'  placeholder='State Name' className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2  focus:ring-orange-500'/>
                    </div>
                </div>
